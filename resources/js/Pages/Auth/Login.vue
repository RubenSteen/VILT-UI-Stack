            ...
            <div class="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p class="mt-2 text-center text-sm text-gray-600">
                        Or
                        <inertia-link :href="route('register')" class="font-medium text-indigo-600 hover:text-indigo-500">
                            sign up
                        </inertia-link>
                    </p>
                </div>
                <form class="mt-8 space-y-6" @submit.prevent="submit">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <inertia-link :href="route('password.request')" class="font-medium text-indigo-600 hover:text-indigo-500">
