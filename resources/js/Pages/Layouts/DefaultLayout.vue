    ...
    <master-layout :title="title">
        ...
        <div class="h-screen flex overflow-hidden">
            ...
            <div class="md:hidden">
                <div :class="{ 'pointer-events-none': !showSidebar }" class="fixed inset-0 flex z-40">
                    ...
                    >
                        <div
                            v-show="showSidebar"
                            class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-50"
                        >
            ...
            <div class="flex flex-col w-0 flex-1 overflow-hidden">
                ...
                <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none bg-white" tabindex="0">
                    <!-- Pages -->
                    <slot />
                </main>
            </div>
