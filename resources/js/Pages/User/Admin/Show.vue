                    ...
                    <div class="pt-10 pb-16">
                        ...
                        <div class="px-4 sm:px-6 md:px-0">
                            <div class="py-6">
                                ...
                                <div class="mt-10 divide-y divide-gray-200">
                                    <div class="space-y-1">
                                        <h3 class="text-lg leading-6 font-medium text-gray-900">Actionsc</h3>
                                        <p class="max-w-2xl text-sm text-gray-500">Manage the users account.</p>
                                    </div>
                                    <div class="mt-6">
                                        <dl class="divide-y divide-gray-200">
                                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                                ...
                                                <dd class="mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                    ...
                                                    <button
                                                        ...
                                                        type="button"
                                                        aria-pressed="true"
                                                        aria-labelledby="delete-option-label"
                                                        :class="[
                                                            user.deleted_at === null ? 'bg-gray-200' : 'bg-purple-600',
                                                        ]"
